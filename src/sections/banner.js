...
import bannerBg from 'assets/images/banner-bg-2.jpg';
        ...
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.bannerContent}>
            <Heading as="h1" sx={styles.heroTitle}>
              Undangan digital untuk hari bahagiamu
            </Heading>
            <Text as="p" sx={styles.desc}>
              Cukup dengan beberapa langkah mudah,
              undangan digitalmu selesai.
            </Text>
            <Button type="submit" sx={styles.button} variant="primary">
              Ayo buat undangan mu
            </Button>
